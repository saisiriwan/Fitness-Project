...
            MAX(sls.actual_weight_kg) as max_weight,
            SUM(sls.actual_reps) as total_reps,
...
('Lat Pulldown', 'strength', ARRAY['Lats', 'Biceps'], 'Pull (Vertical)', 'นั่งดึงบาร์ลงมาหาหน้าอก', 'Machine', 'strength', ARRAY['Weight', 'Reps'], '80-110'),
('Seated Cable Row', 'strength', ARRAY['Back', 'Rhomboids'], 'Pull', 'นั่งดึงเคเบิลเข้าหาลำตัว บีบสะบัก', 'Machine', 'strength', ARRAY['Weight', 'Reps'], '80-110'),
...
('Face Pull', 'strength', ARRAY['Rear Delts', 'Rotator Cuff'], 'Pull', 'ดึงเชือกเข้าหาหน้าผาก กางศอกออก', 'Machine', 'strength', ARRAY['Weight', 'Reps'], '50-80'),
...
('Leg Press', 'strength', ARRAY['Quads', 'Glutes'], 'Squat', 'นอนถีบเครื่องด้วยส้นเท้า', 'Machine', 'strength', ARRAY['Weight', 'Reps'], '100-150'),
...
('Leg Curl', 'strength', ARRAY['Hamstrings'], 'Isolation', 'นอนคว่ำหรือนั่ง พับขาเข้าหาตัวต้านน้ำหนัก', 'Machine', 'strength', ARRAY['Weight', 'Reps'], '60-90'),
...
('Barbell Squat', 'strength', ARRAY['Quadriceps', 'Glutes', 'Core'], 'Squat', 'ยืนกางขาเท่าไหล่ ค่อยๆ นั่งลงจนต้นขาขนานกับพื้น แล้วยืนขึ้น', 'Compound', 'strength', ARRAY['Weight (น้ำหนัก)', 'Reps (จำนวนครั้ง)'], '100-150'),
('Bench Press', 'strength', ARRAY['Chest', 'Shoulders', 'Triceps'], 'Push', 'นอนบนเก้าอี้ ดันบาร์เบลขึ้นจากหน้าอกจนแขนตึง', 'Compound', 'strength', ARRAY['Weight (น้ำหนัก)', 'Reps (จำนวนครั้ง)'], '80-120'),
('Deadlift', 'strength', ARRAY['Hamstrings', 'Glutes', 'Back'], 'Hinge', 'ยืนหลังตรง ค่อยๆ ก้มลงยกบาร์เบลขึ้นมา', 'Compound', 'strength', ARRAY['Weight (น้ำหนัก)', 'Reps (จำนวนครั้ง)'], '120-180'),
...
('Treadmill Running', 'cardio', ARRAY['Legs', 'Core'], 'Locomotion', 'วิ่งบนลู่วิ่งด้วยความเร็วและระยะเวลาที่กำหนด', 'Cardio', 'distance_long', ARRAY['Distance-Long (ระยะทางไกล)', 'Time (เวลา)'], '200-300'),
